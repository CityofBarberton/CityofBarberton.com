		...
		if file_contents:
			...
			if file_contents:
				...
				if file_contents:
					...
					file_contents = re.sub(' a ', ' ', file_contents)
					file_contents = re.sub(' b ', ' ', file_contents)
					file_contents = re.sub(' c ', ' ', file_contents)
					file_contents = re.sub(' x ', ' ', file_contents)
					file_contents = re.sub(' j. ', ' ', file_contents)
					file_contents = re.sub(' w. ', ' ', file_contents)
					file_contents = re.sub(' an ', ' ', file_contents)
					file_contents = re.sub(' be ', ' ', file_contents)
					file_contents = re.sub(' do ', ' ', file_contents)
					file_contents = re.sub(' if ', ' ', file_contents)
					file_contents = re.sub(' in ', ' ', file_contents)
					file_contents = re.sub(' or ', ' ', file_contents)
					file_contents = re.sub(' so ', ' ', file_contents)
					file_contents = re.sub(' to ', ' ', file_contents)
					file_contents = re.sub(' us ', ' ', file_contents)
					file_contents = re.sub(' up ', ' ', file_contents)
					file_contents = re.sub(' ne ', ' ', file_contents)
					file_contents = re.sub(' nw ', ' ', file_contents)
					file_contents = re.sub(' we ', ' ', file_contents)
					file_contents = re.sub(' rd ', ' ', file_contents)
					file_contents = re.sub(' st ', ' ', file_contents)
					file_contents = re.sub(' nw. ', ' ', file_contents)
					file_contents = re.sub(' st. ', ' ', file_contents)
					...
					file_contents = re.sub(' 1st ', ' ', file_contents)
					file_contents = re.sub(' 2nd ', ' ', file_contents)
					file_contents = re.sub(' 3rd ', ' ', file_contents)
					file_contents = re.sub(' 4th ', ' ', file_contents)
					file_contents = re.sub(' 5th ', ' ', file_contents)
					file_contents = re.sub(' 6th ', ' ', file_contents)
					file_contents = re.sub(' 7th ', ' ', file_contents)
					file_contents = re.sub(' 8th ', ' ', file_contents)
					file_contents = re.sub(' 9th ', ' ', file_contents)
					file_contents = re.sub(' and ', ' ', file_contents)
					file_contents = re.sub(' are ', ' ', file_contents)
					file_contents = re.sub(' etc ', ' ', file_contents)
					file_contents = re.sub(' not ', ' ', file_contents)
					file_contents = re.sub(' see ', ' ', file_contents)
					file_contents = re.sub(' the ', ' ', file_contents)
					file_contents = re.sub(' was ', ' ', file_contents)
					file_contents = re.sub(' inc. ', ' ', file_contents)
					file_contents = re.sub(' have ', ' ', file_contents)
					file_contents = re.sub(' only ', ' ', file_contents)
